...
**References:** F7-D1 Forensic Report (`docs/F7_D1_FORENSIC_PROFILING_REPORT_01.md`); Consultant Letter 2026-09-09 (§7 causal experiment); Director Response (`docs/F7_DIRECTOR_RESPONSE_TO_CONSULTANT_01.md` §4 Paso 3); F7-1 Pilot (Result C).
